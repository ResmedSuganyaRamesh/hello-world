...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      h1("Installation"),
      p("Shiny is available on CRAN, so you can install it in the usual way from 
        your R console:"),
    ...
    mainPanel(
      ...
      p("- Shiny applications are automatically 'live' in the same way theat", strong("spreadsheets"), "are live.
